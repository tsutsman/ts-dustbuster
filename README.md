...
Після запуску відкрийте `http://localhost:3000`. Оновлений інтерфейс містить:

- блок довідки про попередні вимоги (права доступу, конфігурації, dry-run);
- контекстні підказки до кнопки очищення та індикатор стану запиту;
- розділ з поясненнями журналу й сценаріями усунення типових помилок;
- посилання на документацію для глибшого налаштування.

GUI працює локально та не має автентифікації, тому не публікуйте його у відкритих мережах.
